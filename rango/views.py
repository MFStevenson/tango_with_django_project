...
def index(request):
	...
	# Order the categories by the nimber of likes in decending order.
...
def about(request):
	...
	context_dict = {'boldmessage': 'This tutorial has been put together by Mia Stevenson'}
...
def register(request):
	...
	if request.method == 'POST':
		...
		if user_form.is_valid() and profile_form.is_valid():
			...
			# Now we save the UserProfile model instanc
			profile.save()

			# Update our variable to indivate that the template
...
def user_login(request):
	...
	# The request is not a HTTP POST, so display the logon form.
